...
read_file = pd.read_csv ('Emmanuel_02_RAPID_HTS.csv')
read_file.to_excel ('converted.xlsx', index = None, header=True)

wb2 = Workbook()
# set file path
filepath2="Emmanuel_HC_HTSNew.xlsx"
# save workbook 
wb2.save(filepath2)
...
heina = '2.25.71280592878078638113873461180761116323&2.25.71280592878078638113873461180761116323'
